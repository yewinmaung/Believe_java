							...
							<div
								...
								<nav aria-label="breadcrumb">
									<ol class="breadcrumb"
										...
										<li class="breadcrumb-item "><a
											href="<%=request.getContextPath()%>/CategoryListServlet"
											class="text-col text-decoration-none">Class List</a></li>
										<li class="breadcrumb-item active text-col"
											aria-current="page">Class</li>
									</ol>
								</nav>
								<!-- Admin Profile -->
							...
							<div class="row d-flex justify-content-center">
								<div class="card"
									...
									<form class="form-group" method="post"
										action="<%=request.getContextPath()%>/UpdateClassServlet"
										enctype="multipart/form-data">
										<input type="hidden" required value="${catlist.id}" name="classid">
										<div class="row my-3">
											<div class="col-md-12 col-12">
												<input type="text" required value="${catlist.title }" name="title" class="form-control"
											...
											<div class="col-md-12 col-12 my-1">
												<label class="form-label text-col">Course Image</label> <input
													type="file" name="cimg" required value="${catlist.img }" class="form-control"
													placeholder="Image">
											</div>
											<div class="col-md-12 col-12 mt-2">
												<input type="text" required name="price" value="${catlist.price}" class="form-control"
													placeholder="Price">
											</div>
										</div>
										<div
